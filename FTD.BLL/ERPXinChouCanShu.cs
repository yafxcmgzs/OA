...
namespace FTD.BLL
{
	...
	public class ERPXinChouCanShu
	{
		...
		/// 得到一个对象实体
		/// </summary>
		public ERPXinChouCanShu(int ID)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select ID,ItemName,BackInfo,UserName,TimeStr ");
			strSql.Append(" FROM ERPXinChouCanShu ");
		...
		return DbHelperSQL.GetMaxID("ID", "ERPXinChouCanShu"); 
		}
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select count(1) from ERPXinChouCanShu");
			strSql.Append(" where ID=@ID ");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into ERPXinChouCanShu(");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update ERPXinChouCanShu set ");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from ERPXinChouCanShu ");
			strSql.Append(" where ID=@ID ");
			SqlParameter[] parameters = {
					new SqlParameter("@ID", SqlDbType.Int,4)};
			parameters[0].Value = ID;
