...
namespace FTD.BLL
{
    ...
    public class ERPWorkPlan
    {
        ...
        public bool Exists(int ID)
        {
            ...
            strSql.Append("select count(1) from ERPWorkPlan");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("insert into ERPWorkPlan(");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("update ERPWorkPlan set ");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("delete ERPWorkPlan ");
            strSql.Append(" where ID=" + ID + " ");
            SqlParameter[] parameters = {
					new SqlParameter("@ID", SqlDbType.Int,4)				};
            parameters[0].Value = ID;
        ...
        public void GetModel(int ID)
        {
            ...
            strSql.Append(" FROM ERPWorkPlan ");
            strSql.Append(" where ID=" + ID + " ");
            SqlParameter[] parameters = {
					new SqlParameter("@ID", SqlDbType.Int,4)				};
            parameters[0].Value = ID;
