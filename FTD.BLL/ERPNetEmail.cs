...
namespace FTD.BLL
{
    ...
    public class ERPNetEmail
    {
        ...
        public bool Exists(int ID)
        {
            ...
            strSql.Append("select count(1) from ERPNetEmail");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("insert into ERPNetEmail(");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("update ERPNetEmail set ");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("delete ERPNetEmail ");
            strSql.Append(" where ID=" + ID + " ");
            SqlParameter[] parameters = {
					new SqlParameter("@ID", SqlDbType.Int,4)				};
            parameters[0].Value = ID;
        ...
        public void GetModel(int ID)
        {
            ...
            strSql.Append(" FROM ERPNetEmail ");
            strSql.Append(" where ID=" + ID + " ");
            SqlParameter[] parameters = {
					new SqlParameter("@ID", SqlDbType.Int,4)				};
            parameters[0].Value = ID;
