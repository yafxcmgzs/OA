...
namespace FTD.BLL
{
	...
	public class ERPCYDIC
	{
		...
		return DbHelperSQL.GetMaxID("ID", "ERPCYDIC"); 
		}
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select count(1) from ERPCYDIC");
			strSql.Append(" where ID=@ID ");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into ERPCYDIC(");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update ERPCYDIC set ");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from ERPCYDIC ");
			strSql.Append(" where ID=@ID ");
			SqlParameter[] parameters = {
					new SqlParameter("@ID", SqlDbType.Int,4)};
			parameters[0].Value = ID;
